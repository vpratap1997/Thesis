...
for i=1:m
    ...
    alpha=(1/(q(1)*x^4 + q(2)*y^4 + q(3)*z^4 + q(4)*x^3*y + q(5)*x^3*z + q(6)*y^3*x + q(7)*y^3*z + q(8)*z^3*x + q(9)*z^3*y + q(10)*x^2*y*z + q(11)*y^2*x*z + q(12)*z^2*y*x + q(13)*x^2*y^2 + q(14)*y^2*z^2 + q(15)*z^2*x^2))^(1/4);
    if any(imag(alpha))
